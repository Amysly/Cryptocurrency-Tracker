...
const Footer = () => {
  return (
    <div className="bg-gray-900 p-5 mt-3">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 text-center lg:text-left">
        ...
        <div className="cursor-pointer">
          ...
          <p className="text-gray-500 font-bold mb-2">Advertise</p>
          <p className="text-gray-500 font-bold mb-2">Academy</p>
          <p className="text-gray-500 font-bold mb-2">Portfolio</p>
        ...
        <div className="cursor-pointer">
          ...
          <p className="text-gray-500 font-bold mb-2">LinkedIn</p>
        </div>
      </div>
